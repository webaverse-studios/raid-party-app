...
class ShoulderPoser {
  ...
  updateHips() {
    ...
    const upperChestPosition = neckPosition.sub(
      localVector2
        .copy(this.shoulder.neck.position)
        .applyQuaternion(hmdXYRotation),
    );
    const chestPosition = upperChestPosition.sub(
      localVector2
        .copy(this.shoulder.upperChest.position)
        .applyQuaternion(hmdXYRotation),
    );
    const spinePosition = chestPosition.sub(
      localVector2
        .copy(this.shoulder.chest.position)
        .applyQuaternion(hmdXYRotation),
    );
    ...
    const rootPosition = hipsPosition.sub(
      localVector2
        .copy(this.shoulder.hips.position)
        .applyQuaternion(hmdXYRotation),
    );
