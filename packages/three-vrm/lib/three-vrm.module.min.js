 ...
 * https://github.com/pixiv/three-vrm/blob/release/LICENSE
 */const Qe=new e.Vector3;class Xe extends e.Group{constructor(t){super(),this._attrPosition=new e.BufferAttribute(new Float32Array([0,0,0,0,0,0]),3),this._attrPosition.setUsage(e.DynamicDrawUsage);const i=new e.BufferGeometry;i.setAttribute("position",this._attrPosition);const n=new e.LineBasicMaterial({color:16711935,depthTest:!1,depthWrite:!1});this._line=new e.Line(i,n),this.add(this._line),this.constraint=t}updateMatrixWorld(e){Qe.setFromMatrixPosition(this.constraint.destination.matrixWorld),this._attrPosition.setXYZ(0,Qe.x,Qe.y,Qe.z),this.constraint.source&&Qe.setFromMatrixPosition(this.constraint.source.matrixWorld),this._attrPosition.setXYZ(1,Qe.x,Qe.y,Qe.z),this._attrPosition.needsUpdate=!0,super.updateMatrixWorld(e)}}function Ge(e,t){return t.set(e.elements[12],e.elements[13],e.elements[14])}const Ye=new e.Vector3,qe=new e.Vector3;function $e(e){return e.invert?e.invert():e.inverse(),e}class Ze{constructor(e,t){this.destination=e,this.source=t,this.weight=1}}const Je=new e.Vector3,Ke=new e.Vector3,et=new e.Vector3,tt=new e.Quaternion,it=new e.Quaternion,nt=new e.Quaternion;class rt extends Ze{constructor(t,i){super(t,i),this._aimAxis="PositiveX",this._v3AimAxis=new e.Vector3(1,0,0),this._dstRestQuat=new e.Quaternion}get aimAxis(){return this._aimAxis}set aimAxis(e){this._aimAxis=e,this._v3AimAxis.set("PositiveX"===e?1:"NegativeX"===e?-1:0,"PositiveY"===e?1:"NegativeY"===e?-1:0,"PositiveZ"===e?1:"NegativeZ"===e?-1:0)}get dependencies(){const e=new Set([this.source]);return this.destination.parent&&e.add(this.destination.parent),e}setInitState(){this._dstRestQuat.copy(this.destination.quaternion)}update(){this.destination.updateWorldMatrix(!0,!1),this.source.updateWorldMatrix(!0,!1);const e=tt.identity(),t=it.identity();var i,n;this.destination.parent&&(i=this.destination.parent.matrixWorld,n=e,i.decompose(Ye,n,qe),$e(t.copy(e)));const r=Je.copy(this._v3AimAxis).applyQuaternion(this._dstRestQuat).applyQuaternion(e),o=Ge(this.source.matrixWorld,Ke).sub(Ge(this.destination.matrixWorld,et)).normalize(),s=nt.setFromUnitVectors(r,o).premultiply(t).multiply(e).multiply(this._dstRestQuat);this.destination.quaternion.copy(this._dstRestQuat).slerp(s,this.weight)}}
/*! *****************************************************************************
Copyright (c) Microsoft Corporation.
