...
const _updateHorizontalSideScroll = direction => {
...
const _updateHorizontalTopDown = direction => {
  if (ioManager.keys.left) {
    direction.x -= 1;
  } else if (ioManager.keys.right) {
    direction.x += 1;
  } else if (ioManager.keys.up) {
    direction.z -= 1;
  } else if (ioManager.keys.down) {
    direction.z += 1;
  }
};
const _updateHorizontalIsometric = direction => {
  if (ioManager.keys.left) {
    direction.x -= 1;
  } else if (ioManager.keys.right) {
    direction.x += 1;
