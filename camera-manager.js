...
class CameraManager extends EventTarget {
  ...
  getViewFactor() {
    return scene2DManager.enabled ? scene2DManager.viewSize : null;
  }
            ...
            if (scene2DManager.cameraMode === 'fixed') {
              if (scene2DManager.scrollDirection === 'horizontal') {
                this.targetPosition
                  ...
                  .sub(new THREE.Vector3(camera.position.x, 0, 0));
                break;
                ...
                this.targetPosition
                  .copy(new THREE.Vector3(0, localPlayer.position.y, 0))
                  .add(new THREE.Vector3(0, offset.y, 10));
                break;
              ...
              this.targetPosition
                .copy(localPlayer.position)
                .add(
                  new THREE.Vector3(0, 0, 10).applyQuaternion(
                    camera.quaternion,
                  ),
                );
            }
