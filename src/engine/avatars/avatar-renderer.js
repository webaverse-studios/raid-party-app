...
const _abortablePromise = async (promise, {signal = null} = {}) => {
...
const _loadGlbObject = async (glbData, srcUrl, {signal = null} = {}) => {
            ...
            this.crunchedModelPromise = (async () => {
              await Promise.all([
                (async () => {
                  ...
                  const object = await _loadGlbObject(glbData, this.srcUrl, {
                    signal,
                  });
